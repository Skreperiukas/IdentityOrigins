...
public class IdentityFabricConfig extends IdentityConfig implements Config {
	...
	@Comment(value = "How many ticks will Identity cooldown take.")
    public int identityCooldown = 200;
	
	@Comment(value = "How many ticks will Identity duration take.")
    public int identityDuration = 100;
	
	@Comment(value = "Cracking Bones sound distance in blocks.")
    public int soundDistance = 24;
	...
	@Override
	public int identityCooldown() {
		return identityCooldown;
	}

	@Override
	public int identityDuration() {
		return identityDuration;
	}
