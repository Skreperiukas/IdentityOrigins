...
public class IdentityDurationC2SPacket {
...
//        }, player.getBlockPos(), SpawnReason.TRIGGERED, true, true); // debug
		...
		if(ModComponents.getIdentityDuration(player) <= 0) ModComponents.setIdentityDuration(player, IdentityConfig.getInstance().identityDuration());
